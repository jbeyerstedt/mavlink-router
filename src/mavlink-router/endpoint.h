...
public:
    ...
    void add_to_allow_sysID_ingoing_filter(uint32_t src_sys_id) { _allow_sysID_ingoing_filter.push_back(src_sys_id); }
...
private:
    ...
    std::vector<uint8_t> _allow_sysID_ingoing_filter;
};
